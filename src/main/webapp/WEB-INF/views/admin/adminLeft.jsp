...
<div class="list-group list-group-flush">
  ...
  <div class="collapse" id="productMenu">
    <a href="#" target="adminContent" class="list-group-item list-group-item-action ps-4">· 상품카테고리</a>
    <a href="#" target="adminContent" class="list-group-item list-group-item-action ps-4">· 상품등록관리</a>
    <a href="#" target="adminContent" class="list-group-item list-group-item-action ps-4">· 상품리스트</a>
