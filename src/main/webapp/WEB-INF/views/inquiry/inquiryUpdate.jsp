  ...
  <br/>
	<form name="myform" method="post" enctype="multipart/form-data">
		...
		<table class="table table-bordered">
			...
			<tr> 
				<th>주문번호</th>
				<td><input type="text" name="orderId" value="${vo.orderId}" class="form-control" maxlength="100"/></td>
			</tr>
			<tr> 
				<th>내용</th>
				<td>
			...
			<tr>
			  <td colspan='2' class="text-center">
			    ...
			    <input type="button" value="돌아가기" onclick="location.href='${ctp}/inquiry/inquiryContent?idx=${vo.idx}&pag=${pag}';" class="btn btn-primary w-25"/>
			  </td>
			</tr>
		</table>
		<p><br/></p>
