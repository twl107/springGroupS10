          ...
          <form name="myform" method="post" action="${ctp}/member/memberJoin">
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <button class="btn btn-success" type="button" id="certificationBtn">인증번호 받기</button>
              </div>
...
<script>
  ...
  // jQuery의 $(function() { ... })는 document.addEventListener('DOMContentLoaded', ...)와 동일한 역할을 합니다.
  // 이 페이지는 이미 jQuery를 사용하고 있으므로, jQuery 방식으로 통일하는 것이 더 안정적입니다.
  $(function() {
    let idCheckSw = false;
        ...
        success: (res) => {
          if (res.trim() !== "0") {
            ...
            let str = `<div class="input-group">
                         <input type="text" name="checkKey" id="checkKey" class="form-control" placeholder="인증번호 6자리"/>
