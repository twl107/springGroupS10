  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-4 mb-4">
        <h2 class="h4 fw-bold">Scheherazade</h2>
        <p class="mt-3">
          최고의 음향기기 전문 쇼핑몰. 당신의 음악 생활을 업그레이드하세요.
        </p>
      </div>
      <div class="col-lg-8 mb-4">
        <div class="row">
          ...
          <div class="col-md-4 mb-4">
            ...
            <p class="mt-3">
              Email: contact@scheherazade.com<br>
              Phone: 02-1234-5678
            </p>
          </div>
        </div>
    ...
    <div class="border-top border-secondary pt-4 mt-2">
      <p class="text-center small">&copy; 2025 Scheherazade. All rights reserved.</p>
    </div>
  </div>
</footer>
